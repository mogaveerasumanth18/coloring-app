...
export class PngTemplateService {
  ...
  private static readonly TEMPLATE_DEFINITIONS = [
    ...
    // New templates - Nature & Simple Objects
    {
      id: 'outline025_tree',
      title: 'Big Tree',
      difficulty: 'easy' as const,
      category: 'objects' as const,
      description: 'Simple tree with branches and leaves',
      tags: ['nature', 'tree', 'simple'],
    },
    {
      id: 'outline026_sun',
      title: 'Happy Sun',
    ...
    {
      id: 'outline027_rainbow',
      title: 'Rainbow',
      difficulty: 'easy' as const,
      category: 'objects' as const,
      description: 'Colorful rainbow with clouds',
      tags: ['rainbow', 'weather', 'colors'],
    },
    {
      id: 'outline028_heart',
      title: 'Love Heart',
      difficulty: 'easy' as const,
      category: 'objects' as const,
      description: 'Simple heart shape',
      tags: ['heart', 'love', 'simple'],
    },
    {
      id: 'outline029_star',
      title: 'Shooting Star',
      difficulty: 'easy' as const,
      category: 'objects' as const,
      description: 'Star with trailing sparkles',
      tags: ['star', 'space', 'magic'],
    },
    // New Animals
    {
      id: 'outline030_cat',
      ...
      difficulty: 'easy' as const,
      category: 'animals' as const,
      description: 'Adorable sitting cat',
      tags: ['cat', 'pet', 'cute'],
    },
    {
      id: 'outline031_fish',
      ...
      tags: ['fish', 'tropical', 'ocean'],
    },
    {
      id: 'outline032_elephant',
      title: 'Friendly Elephant',
      difficulty: 'medium' as const,
      category: 'animals' as const,
      description: 'Large elephant with trunk',
      tags: ['elephant', 'safari', 'large'],
    },
    {
      id: 'outline033_owl',
      title: 'Wise Owl',
      difficulty: 'medium' as const,
      category: 'animals' as const,
      description: 'Owl sitting on a branch',
      tags: ['owl', 'bird', 'wise'],
    },
    {
      id: 'outline034_lion',
      ...
      difficulty: 'medium' as const,
      category: 'animals' as const,
      description: 'Majestic lion with mane',
      tags: ['lion', 'king', 'safari'],
    },
    // New Vehicles
    {
      id: 'outline035_car',
    ...
    },
    {
      ...
      difficulty: 'medium' as const,
      category: 'vehicles' as const,
      description: 'Old-fashioned steam locomotive',
      tags: ['train', 'steam', 'vintage'],
    },
    {
      id: 'outline037_boat',
      title: 'Sailing Boat',
      difficulty: 'medium' as const,
      category: 'vehicles' as const,
      description: 'Sailboat on the water',
      tags: ['boat', 'sailing', 'water'],
    },
    // New Buildings & Objects
    {
      id: 'outline038_lighthouse',
      title: 'Lighthouse',
      difficulty: 'medium' as const,
      category: 'buildings' as const,
      description: 'Tall lighthouse by the sea',
      tags: ['lighthouse', 'sea', 'navigation'],
    },
    {
      id: 'outline039_windmill',
      title: 'Windmill',
      difficulty: 'medium' as const,
      category: 'buildings' as const,
      description: 'Traditional windmill',
      tags: ['windmill', 'countryside', 'traditional'],
    },
    {
      id: 'outline040_ice_cream',
  ...
  private static templateAssets: { [key: string]: any } = {
    ...
    // New template assets
    outline025_tree: require('../assets/templates/outline025_tree.png'),
    outline026_sun: require('../assets/templates/outline026_sun.png'),
    outline027_rainbow: require('../assets/templates/outline027_rainbow.png'),
    outline028_heart: require('../assets/templates/outline028_heart.png'),
    outline029_star: require('../assets/templates/outline029_star.png'),
    outline030_cat: require('../assets/templates/outline030_cat.png'),
    outline031_fish: require('../assets/templates/outline031_fish.png'),
    outline032_elephant: require('../assets/templates/outline032_elephant.png'),
    outline033_owl: require('../assets/templates/outline033_owl.png'),
    outline034_lion: require('../assets/templates/outline034_lion.png'),
    outline035_car: require('../assets/templates/outline035_car.png'),
    outline036_train: require('../assets/templates/outline036_train.png'),
    outline037_boat: require('../assets/templates/outline037_boat.png'),
    outline038_lighthouse: require('../assets/templates/outline038_lighthouse.png'),
    outline039_windmill: require('../assets/templates/outline039_windmill.png'),
    outline040_ice_cream: require('../assets/templates/outline040_ice_cream.png'),
  };
